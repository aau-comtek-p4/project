#ifndef LIBURING_FILE_WRITE_TRANSPORT_H
#define LIBURING_FILE_WRITE_TRANSPORT_H

#include "general/interfaces/io/transports/storage_transport.h"
#include <liburing.h>
class LiburingFileWriteIOTransport : public StorageIOTransport {
private:
  io_uring ring;

public:
  LiburingFileWriteIOTransport(uint64_t queue_depth);
